...
const (
	// Label holds the string label denoting the workflownodeinstance type in the database.
	Label = "workflow_node_instance"
	...
	FieldJobID = "job_id"
	// FieldJobInstanceID holds the string denoting the job_instance_id field in the database.
	...
	// Table holds the table name of the workflownodeinstance in the database.
	Table = "workflow_node_instances"
)

// Columns holds all SQL columns for workflownodeinstance fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the WorkflowNodeInstance queries.
...
// ByJobInstanceID orders the results by the job_instance_id field.
func ByJobInstanceID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldJobInstanceID, opts...).ToFunc()
}
