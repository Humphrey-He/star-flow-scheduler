...
type ServiceContext struct {
	...
	WorkflowNodes *repo.WorkflowNodeRepository
}
...
func NewServiceContext(c config.Config) *ServiceContext {
	...
	return &ServiceContext{
		...
		Redis:         redisClient,
		Workflows:     repo.NewWorkflowRepository(database.Client),
		WorkflowNodes: repo.NewWorkflowNodeRepository(database.Client),
	}
}
